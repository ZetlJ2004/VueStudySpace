...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/exa18',
    component: () => import('@/views/example18/IndexView.vue'),S
  },
  // -------------- homework
  {
    path: '/exp02',
  ...
  {
    path: '/homework01',
    component: () => import('@/views/homework1/IndexView.vue')
  },
  {
    path: '/homework02',
    component: () => import('@/views/homework2/IndexView.vue')
  },
  {
    path: '/homework03',
    component: () => import('@/views/homework3/IndexView.vue')
  },
  {
    path: '/homework04',
    component: () => import('@/views/homework4/IndexView.vue')
  },
  {
    path: '/homework05',
    component: () => import('@/views/homework5/IndexView.vue')
  }
]
